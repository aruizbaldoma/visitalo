...
def forgot_password_email_html(name: str, reset_link: str) -> str:
    """Plantilla para self-service de recuperación: el usuario hace clic en
    el link y elige una nueva contraseña. El link expira en 1 hora."""
    safe_name = (name or "").strip() or "viajero"
    return f"""
<!DOCTYPE html>
<html lang="es">
          ...
          <table role="presentation" width="560" cellspacing="0" cellpadding="0" style="max-width:560px;background:#ffffff;border-radius:14px;overflow:hidden;box-shadow:0 2px 12px rgba(3,24,52,0.06);">
            ...
            <tr>
              <td style="padding:32px;">
                ...
                <p style="margin:0 0 16px;font-size:15px;line-height:1.6;color:#334155;">
                  Recibimos una solicitud para restablecer tu contraseña en Visitalo.es. Pulsa el botón para elegir una nueva clave.
                </p>
                <div style="margin:28px 0;text-align:center;">
                  <a href="{reset_link}" style="display:inline-block;padding:14px 28px;background:#3ccca4;color:#031834;font-weight:700;font-size:15px;text-decoration:none;border-radius:999px;">
                ...
                <p style="margin:24px 0 0;font-size:13px;line-height:1.6;color:#64748b;">
                  Este enlace expira en 1 hora. Si no solicitaste este cambio, ignora este mensaje y tu contraseña seguirá intacta.
                </p>
              </td>
            </tr>
            <tr>
